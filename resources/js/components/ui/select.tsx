...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base styles
        "flex h-11 w-full items-center justify-between rounded-lg border bg-background px-4 py-2.5 text-base transition-all duration-200 outline-none cursor-pointer",
        // Border and shadow
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Base styles
        "relative flex w-full items-center gap-2 rounded-lg py-2.5 pr-10 pl-3 text-sm cursor-pointer select-none outline-none transition-colors",
        // Focus/hover state
